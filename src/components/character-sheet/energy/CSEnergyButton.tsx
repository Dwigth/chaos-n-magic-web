...
const EnergyBox = styled(Checkbox)(({ theme }) => ({
  ...
  backgroundColor: theme.palette.mode === "dark" ? "rgba(16,22,26,0)" : "#f5f8fa",
  backgroundImage:
    theme.palette.mode === "dark"
  ...
  return (
    ...
    >
      <EnergyBox
        ...
        color="default"
        checkedIcon={
          <img src="/src/assets/images/charsheet/Energy_Full_Icon.png" width={32}/>
        }
        icon={
          <img src="/src/assets/images/charsheet/Energy_Unchecked_Icon.png" width={32}/>
        }
